...
function Avatar({
  ...
  const innerBorderClasses = withInnerBorder
    ? "dark:after:mix-blend-lighten after:absolute after:inset-0 after:rounded-full after:border after:border-border after:mix-blend-darken"
    : "";
  return (
